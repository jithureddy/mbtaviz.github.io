 ...
 *************************************************************/
var defaultHeatMapFor = "items";
function renderHeatMapOnLoad(items) {
  VIZ.requiresData([
...
renderHeatMapOnLoad("items");
VIZ.reRenderHeatMap = function (optionValue) {
  defaultHeatMapFor = optionValue;
  renderHeatMapOnLoad();
}



function renderHeatMap(turnstile, turnstileToGtfs) {
  "use strict";
 ...
 *************************************************************/
  ...
  allStationHeatmap
    ...
    .call(drawStop, 'All Stations', turnstile[defaultHeatMapFor], turnstile[defaultHeatMapFor], true)
    .call(tip);
  ...
  *************************************************************/
  ...
  heatmaps.selectAll('rect')
    .data(function (d) {
      return d.parent.averagesByType[d.day].filter(function (d) { return !!d; }).map(function (other) {
        return {
          hour: other.hour,
          datum: other[d.type],
          name: d.parent.name,
